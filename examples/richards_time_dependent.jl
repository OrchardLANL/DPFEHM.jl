...
Qs[injectionnode] = 1e-6 #1e-4 #m^3/s
...
function f_gw_p(u, p, t)
    Ks, dirichleths = unpack(p)
    J1 = DPFEHM.richards_Ks(u, Ks, neighbors, areasoverlengths, dirichletnodes, dirichleths, coords_richards, alphas, Ns, Qs, specificstorage, volumes)
    J2 = DPFEHM.richards_dirichletpsis(u, Ks, neighbors, areasoverlengths, dirichletnodes, dirichleths, coords_richards, alphas, Ns, Qs, specificstorage, volumes)
    return hcat(J1, J2)
end
